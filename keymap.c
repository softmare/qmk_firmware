...
enum planck_layers { _COLEMAK, _QWERTY, _GAME, _RAISE, _LOWER, _LRCOMBO, _LMOVE, _RMOVE, _MMCOMBO, _MOUSE_TOGGLE, _FUNCTION, _KEYBOARD };
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_COLEMAK]      = LAYOUT_ortho_4x12(//for english colemak
    ...
    [_QWERTY]       = LAYOUT_ortho_4x12(//for hangule
    ...
    [_RAISE]        = LAYOUT_ortho_4x12(//function keys (F1~F12)
    ...
    [_FUNCTION]        = LAYOUT_ortho_4x12(//volume up down
    ...
    [_LOWER]     = LAYOUT_ortho_4x12(//spacial keys
    ...
    [_LMOVE]        = LAYOUT_ortho_4x12(//arrow key. up down
    ...
    [_RMOVE]        = LAYOUT_ortho_4x12( //move mouse
    ...
    [_LRCOMBO]      = LAYOUT_ortho_4x12(
        KC_NO   , KC_NO   , KC_NO   , KC_NO   , GAME, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
        KC_NO   , KC_NO   , KC_NO   , KC_NO   , KC_NO, KC_NO, KC_NO, KC_ASUP, KC_ASDN, KC_ASRP, KC_NO, KC_NO,
        KC_NO   , KC_NO   , KC_NO   , KC_NO   , KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
        KC_TRNS , KC_TRNS , KEYBOARD, KC_TRNS , KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
...
layer_state_t layer_state_set_user(layer_state_t state) {
    ...
    state = update_tri_layer_state(state, _LMOVE, _RMOVE, _MMCOMBO);
